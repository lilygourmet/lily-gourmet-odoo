...
// ⚠️ À LIRE AVANT REACT : l'app réécrit l'adresse au démarrage et emporterait
// le `?article=` du QR. Ce module le met de côté au premier instant.
import './lib/scanEntrant'
