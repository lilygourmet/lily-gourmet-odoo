...
export async function createUser({
  ...
  perm_transfert_envoi = false, perm_transfert_reception = false,
    ...
    try {
      await supabase
        ...
        .update({
          ...
          perm_transfert_envoi,
          perm_transfert_reception,
          perm_facture_ocp,
          perm_notif_modif,
          perm_modification,
          livreur_defaut,
...
export async function updateUser(userId, {
  ...
  perm_stock_poly,
  perm_simu_gateaux,
  perm_transfert_annexe, perm_transfert_boutique, perm_transfert_produits, perm_transfert_envoi, perm_transfert_reception,
  perm_facture_ocp,
  perm_notif_modif,
  perm_modification,
  livreur_defaut,
  ...
  if (perm_transfert_envoi !== undefined) updates.perm_transfert_envoi = perm_transfert_envoi
  if (perm_transfert_reception !== undefined) updates.perm_transfert_reception = perm_transfert_reception
