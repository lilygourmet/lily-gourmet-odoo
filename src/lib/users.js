...
export async function createUser({
  ...
  perm_commande = false,
  perm_ai_tools = false,
  perm_photoshop = false, perm_valider_of = false,
    ...
    try {
      await supabase
        ...
        .update({
          ...
          perm_commande,
          perm_ai_tools,
          perm_photoshop, perm_valider_of,
          perm_stock_poly,
          perm_simu_gateaux,
