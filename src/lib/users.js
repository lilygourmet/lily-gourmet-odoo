...
export async function createUser({
  ...
  perm_commande = false,
  perm_ai_tools = false,
  perm_photoshop = false, perm_valider_of = false, perm_valider_annexe = false, perm_fabrication_cd = false, perm_fabrication_glacage = false, perm_fabrication_pate_sucre = false, perm_fabrication_prod = false, perm_fabrication_annexe = false,
    ...
    try {
      await supabase
        ...
        .update({
          ...
          perm_commande,
          perm_ai_tools,
          perm_photoshop, perm_valider_of, perm_valider_annexe, perm_fabrication_cd, perm_fabrication_glacage, perm_fabrication_pate_sucre, perm_fabrication_prod, perm_fabrication_annexe,
          perm_stock_poly,
          perm_check_cd,
          perm_simu_gateaux,
...
export async function updateUser(userId, {
  ...
  perm_ai_tools,
  perm_photoshop,
  perm_valider_of, perm_valider_annexe, perm_fabrication_cd, perm_fabrication_glacage, perm_fabrication_pate_sucre, perm_fabrication_prod, perm_fabrication_annexe,
  perm_check_cd,
  perm_stock_poly,
  perm_simu_gateaux,
  perm_transfert_annexe, perm_transfert_boutique, perm_transfert_produits, perm_declarer,
  perm_inventaire,
  ...
  if (perm_valider_annexe !== undefined) updates.perm_valider_annexe = perm_valider_annexe
  ...
  if (perm_fabrication_pate_sucre !== undefined) updates.perm_fabrication_pate_sucre = perm_fabrication_pate_sucre
  if (perm_fabrication_prod !== undefined) updates.perm_fabrication_prod = perm_fabrication_prod
  if (perm_fabrication_annexe !== undefined) updates.perm_fabrication_annexe = perm_fabrication_annexe
  if (perm_stock_poly !== undefined) updates.perm_stock_poly = perm_stock_poly
  if (perm_check_cd !== undefined) updates.perm_check_cd = perm_check_cd
