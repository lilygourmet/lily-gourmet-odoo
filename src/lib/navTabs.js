...
const TAB_DEFS = [
  ...
  { view: 'inventaire-zero',   emoji: '🔍', label: 'Annexe — à zéro',    can: u => !isLivreur(u) && canSeeInventaire(u) },
  { view: 'inventaire-prod',   emoji: '📦', label: 'Inventaire Prod',     can: u => !isLivreur(u) && canSeeInventaire(u) },
  { view: 'inventaire-prod-zero', emoji: '🔍', label: 'Prod — à zéro',    can: u => !isLivreur(u) && canSeeInventaire(u) },
