...
export default function ClotureMoisModal({ balance, year, month, caisseOwner, onClose, onConfirm }) {
  return (
    <ModalBox title={`Clôturer ${MOIS_TABS[month - 1].label} ${year}`} titleColor="#3A3733" titleIcon="📁" onClose={onClose}>
      ...
      <div style={{ background: '#F4F0EA', padding: '14px 16px', borderRadius: 8, marginBottom: 14 }}>
        <div style={{ fontSize: 12, color: '#6F6A60' }}>Solde de clôture (sera reporté sur {MOIS_TABS[month % 12].label})</div>
