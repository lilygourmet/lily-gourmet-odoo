...
export default function AppHeader({ user, activeView, onNavigate, onLogout, onSyncSuccess }) {
  ...
  const menuProduction = [
    ...
    { view: 'transferts-sm', emoji: '📦', label: 'Transferts Produits', visible: !isLivreur(user) && canSeeTransfertsProduits(user) },
  ].filter(i => i.visible)
  ...
  const menuOutils = [
    ...
    { view: 'facture-ocp',      emoji: '🧾', label: 'Facture OCP',      visible: !isLivreur(user) && canSeeFactureOcp(user) },
