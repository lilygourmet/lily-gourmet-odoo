...
const GROUPS = [
  { id: 'prod',   label: 'Production',     emoji: '🥐', views: ['prod', 'fabrication', 'fabrication-glacage', 'fabrication-pate-sucre', 'fabrication-valider', 'sales', 'stock-gs', 'stock-prod-vitrine', 'stock-prod-annexe', 'patissier', 'stock-poly', 'transferts-mp', 'transferts-sm'] },
