...
const GROUPS = [
  { id: 'prod',   label: 'Production',     emoji: '🥐', views: ['prod', 'fabrication', 'fabrication-glacage', 'fabrication-pate-sucre', 'fabrication-prod', 'fabrication-annexe-2', 'a-declarer', 'a-finir', 'donne', 'rebut', 'fabrication-valider', 'valider-annexe', 'minmax-cd', 'minmax-annexe', 'sales', 'stock-gs', 'stock-prod-vitrine', 'stock-prod-annexe', 'inventaire', 'inventaire-prod', 'patissier', 'stock-poly', 'transferts-mp', 'transferts-sm'] },
