...
const GROUPS = [
  { id: 'prod',   label: 'Production',     emoji: '🥐', views: ['prod', 'fabrication', 'fabrication-glacage', 'fabrication-pate-sucre', 'fabrication-prod', 'fabrication-annexe', 'fabrication-valider', 'sales', 'stock-gs', 'stock-prod-vitrine', 'stock-prod-annexe', 'patissier', 'stock-poly', 'transferts-mp', 'transferts-sm'] },
  ...
  { id: 'outils', label: 'Outils',         emoji: '🧰', views: ['etiquettes', 'etiquettes-prix', 'etiquettes-boites', 'messages', 'devis', 'modifications', 'livraisons', 'paiements', 'freezer', 'economat', 'supports', 'simu-gateaux', 'ocp-link', 'facture-ocp', 'cake-vision-link', 'cake-vision-edit', 'ai-gemini', 'ai-chatgpt'] },
]
